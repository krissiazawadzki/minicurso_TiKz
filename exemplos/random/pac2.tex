...
\begin{tikzpicture}
	...
	\filldraw[fill opacity=1,fill=yellow] (3,0) arc (0:360:0.25 cm) -- cycle;
	\filldraw[fill opacity=1,fill=yellow] (4,0) arc (0:360:0.25 cm) -- cycle;
	\filldraw[fill opacity=1,fill=yellow] (5,0) arc (0:360:0.25 cm) -- cycle;
